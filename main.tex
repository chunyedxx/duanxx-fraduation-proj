...
\noindent 关键词：} {\songti\xiaosihao 本体匹配，多视角学习，表示学习，黑箱优化，HORD算法}
\newpage
...
\addcontentsline{toc}{chapter}{\numberline {参考文献}}
\thispagestyle{fancy} \fancyhead[L]{\songti \small
重庆师范大学硕士学位论文} \fancyhead[R]{\songti \small 参考文献}
...
\begin{appendices}
\renewcommand{\baselinestretch}{1}
\topskip 35pt\chapter*{\heiti\sanhao 附录：作者攻读硕士学位期间发表论文及科研情况}
\addcontentsline{toc}{chapter}{\numberline {附录：作者攻读硕士学位期间发表论文及科研情况}}
\thispagestyle{fancy} \fancyhead[L]{\songti \small
重庆师范大学硕士学位论文} \fancyhead[R]{\songti \small 附录：作者攻读硕士学位期间发表论文及科研情况}
\vskip 0.5cm\songti\zihao{-4}
\renewcommand{\thechapter}{}

\noindent \textbf{发表的论文：}

\noindent [1] G.Li, X.Duan and C.Wu. A New DC Algorithm for Sparse Optimal Scoring Problem[J]. IEEE Access, vol 8, pp 53962-53971, 2020.

\noindent [2] Li,W., Duan,X., Wang,M., Zhang,X., Qi,G. Multi-view Embedding for Biomedical Ontology Matching[C]. In Proceedings of the OM2019@ISWC, 2019.
\end{appendices}
\\
\\
\noindent \textbf{参与的基金与课题：}

\noindent 1. 机器学习中大规模非凸优化问题的分布式并行算法研究及其应用、国家自然科学基金面上项目、参与、2019； 

\noindent 2. 具有可分结构非凸优化问题的理论与算法研究、参与、重庆市自然科学基金、 2018-2021； 

\noindent 3. DC规划的理论和算法研究及其在机器学习中的应用、参与、 国家自然科学基金面上项目、2018-2022； 

\noindent 4. 机器学习中几类稀疏优化问题的算法研究、参与、重庆市科委、2019-2022； 

\noindent 5. 用于人脸比对的身份证网纹照片修复技术、参与、横向项目、2018.6； 

\noindent 6. 基于RGBD传感器的人脸活体检测研究、参与、 横向项目、2019.4.1； 

\noindent 7. 预测式自动外呼模型构建、参与、 横向项目、2019.6； 

\noindent 8. BERT 预训练模型对问答机器人的效果提升、参与、 横向项目、2019.6；
