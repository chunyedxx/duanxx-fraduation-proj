...
\section{HORD算法}
\subsection{HORD算法}
{\songti\xiaosihao 近年来，深度学习技术被广泛应用于各种与人工智能相关的应用中，然而，深度学习模型的性能受到模型超参数的制约，而选择合适的参数常常比较困难且耗时，所以，对于深度学习的超参数优化是昂贵的“黑箱”全局优化问题的一种，对于“黑箱“参数优化问题可理解为将需要配置$d$个超参数看作一组向量$x \in {R^d}$，模型本身可以看作关于$x$ 的“黑箱”函数$f(x)$，超参数优化可以看作解决以下的优化问题，在训练集${Z_{train}}$和测试集${Z_{val}}$中，函数$f(x)$ 将$d$ 个可配置超参数中的超参数选择$x$映射到具有学习参数θ 的深度学习算法的验证误差。
\[\begin{array}{l}\large
\begin{array}{*{20}{c}}
